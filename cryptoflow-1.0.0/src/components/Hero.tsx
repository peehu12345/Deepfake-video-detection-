        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 animate-fade-in-left">
            <div className="inline-flex items-center bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-xs text-gray-300">AI-Powered Deepfake Analysis</span>
              <ChevronRight className="h-4 w-4 text-gray-400 ml-1" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              <span className="text-gradient">Detect Deepfakes</span> with Confidence & Clarity
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-lg">
              Experience seamless deepfake detection with real-time analytics, AI-powered insights, and tools for audio, video, and image verification.
            </p>
      ...
      <ArrowRight className="ml-2 h-5 w-5" />
           ...
           {/* <Button variant="outline" size="lg" className="border-gray-700 text-white hover:bg-white/5 py-6">
            ...
            <div className="mt-8 flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Media Files Analyzed</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 mt-12 lg:mt-0 animate-fade-in-right">
            <div className="relative max-w-md mx-auto animate-float">
              <img 
                src="https://plus.unsplash.com/premium_photo-1682756540097-6a887bbcf9b0?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=2071"
              ...
              <div className="absolute -right-6 -bottom-6 bg-crypto-purple/20 backdrop-blur-md rounded-lg p-4 border border-crypto-purple/30 shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-green-500">95.67%</p>
                  </div>
                </div>
              </div>
